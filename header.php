				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mx-auto">
						<li class="nav-item lowheader-link">
							<a class="nav-link" href="search.php">Расширеный поиск<span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item lowheader-link">
							<a class="nav-link" href="index.php#news-block">Новости</a>
						</li>
						<li class="nav-item lowheader-link">
							<a class="nav-link" href="index.php#popular-block">Популярное</a>
						</li>
					</ul>
				</div>
			</nav>
